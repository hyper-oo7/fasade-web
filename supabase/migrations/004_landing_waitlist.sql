-- Landing page: waitlist signups and user research survey responses
...
-- Anonymous visitors can submit waitlist emails and survey responses
...
-- Only service role can read submissions (view in Supabase dashboard)
